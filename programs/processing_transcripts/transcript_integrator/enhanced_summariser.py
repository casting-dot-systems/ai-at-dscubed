    ...
    async def _update_meeting_summary(self, transcript_link: str, summary: str) -> bool:
        ...
        try:
            ...
            if transcript_link in self.meetings:
                ...
                # Pattern: (meeting_id, 'type', 'transcript_link', 'date', '')
                old_pattern = f"({meeting['meeting_id']}, '{meeting['type']}', '{meeting['transcript_link']}', '{meeting['date']}', '')"
                new_pattern = f"({meeting['meeting_id']}, '{meeting['type']}', '{meeting['transcript_link']}', '{meeting['date']}', '{escaped_summary}')"
